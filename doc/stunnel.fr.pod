...
B<Sous NT/2000/XPE<nbsp>:> nom de service NT dans le gestionnaire de tâches.
...
=item B<xforwardedfor> = yes | no

Ajoute un en-tête 'X-Forwarded-For:' dans la requête HTTP fournissant au serveur
